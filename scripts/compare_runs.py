"""Scan runs/**/summary.json (any depth -- runs/<Dataset>/<Model>/<run_name>/)
and print a comparison table across experiments.
...
def main() -> None:
    ...
    header = (
        f"{'run':60s} {'acc':>7s} {'loss':>7s} {'trainable':>10s} {'%params':>7s} "
    ...
    for r in rows:
        ...
        print(
            f"{r['run']:60s} {r['test_acc']:7.4f} {r['test_loss']:7.4f} "
